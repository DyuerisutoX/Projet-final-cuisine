  ...
  <body>
    ...
    <nav class=" nav nav-dark " style="background-color: #d05c62 ;">
      <ul class="nav">
          ...
          <li class="nav-item"><a class=" nav-link" href="../ateliers/index.php">Ajouter un atelier</a></li>
          <li class="nav-item"><a class=" nav-link" href="../ateliers/liste.php">Voir les ateliers</a></li>
      </ul>       
  </nav>
